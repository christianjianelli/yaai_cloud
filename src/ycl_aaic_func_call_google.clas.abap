CLASS ycl_aaic_func_call_google DEFINITION
  PUBLIC
  CREATE PUBLIC.

  PUBLIC SECTION.

    INTERFACES yif_aaic_func_call_google.

    ALIASES on_tool_call          FOR yif_aaic_func_call_google~on_tool_call.
    ALIASES on_tool_call_response FOR yif_aaic_func_call_google~on_tool_call_response.
    ALIASES on_tool_call_error    FOR yif_aaic_func_call_google~on_tool_call_error.

    ALIASES mt_methods FOR yif_aaic_func_call_google~mt_methods.

    ALIASES add_methods FOR yif_aaic_func_call_google~add_methods.
    ALIASES get_tools FOR yif_aaic_func_call_google~get_tools.
    ALIASES reset_methods FOR yif_aaic_func_call_google~reset_methods.
...
CLASS ycl_aaic_func_call_google IMPLEMENTATION.
  ...
  METHOD yif_aaic_func_call_google~call_tool.
  ...
  METHOD yif_aaic_func_call_google~get_tools.
  ...
  METHOD yif_aaic_func_call_google~remove_method.
  ...
  METHOD yif_aaic_func_call_google~reset_methods.
