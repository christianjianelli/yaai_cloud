CLASS ycl_aaic_async_chat_google DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS on_chat_is_blocked FOR EVENT on_chat_is_blocked OF ycl_aaic_google.
...
CLASS ycl_aaic_async_chat_google IMPLEMENTATION.
