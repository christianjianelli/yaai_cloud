CLASS ycl_aaic_http_service_google DEFINITION
  PUBLIC
  CREATE PUBLIC .
        ...
        CASE l_method.
          ...
          WHEN 'GET'.
            ...
            IF l_format IS INITIAL.
              ...
              DATA(lo_aaic_db_get) = NEW ycl_aaic_db( i_api = yif_aaic_const=>c_google
                                                      i_id = CONV #( l_chat_id ) ).

              DATA(l_html) = NEW ycl_aaic_ui_chat( )->get_html( i_api = yif_aaic_const=>c_google
