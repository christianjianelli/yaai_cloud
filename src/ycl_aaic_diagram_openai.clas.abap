CLASS ycl_aaic_diagram_openai DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    INTERFACES yif_aaic_diagram_openai.
    ...
    ALIASES: get_chat_messages FOR yif_aaic_diagram_openai~get_chat_messages,
             ...
             mt_participants FOR yif_aaic_diagram_openai~mt_participants,
             mt_steps FOR yif_aaic_diagram_openai~mt_steps,
             mt_replacements FOR yif_aaic_diagram_openai~mt_replacements,
             m_diagram FOR yif_aaic_diagram_openai~m_diagram,
             m_maxlen FOR yif_aaic_diagram_openai~m_maxlen.
...
CLASS ycl_aaic_diagram_openai IMPLEMENTATION.
