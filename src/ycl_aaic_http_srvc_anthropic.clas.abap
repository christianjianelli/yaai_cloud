CLASS ycl_aaic_http_srvc_anthropic DEFINITION
  PUBLIC
  CREATE PUBLIC .
    ...
    TRY.
        ...
        CASE l_method.
          ...
          WHEN 'GET'.
            ...
            DATA(lo_aaic_db_get) = NEW ycl_aaic_db( i_api = yif_aaic_const=>c_anthropic
                                                    i_id = CONV #( l_chat_id ) ).

            IF l_format IS INITIAL.

              DATA(l_html) = NEW ycl_aaic_ui_chat( )->get_html( i_api = yif_aaic_const=>c_anthropic
