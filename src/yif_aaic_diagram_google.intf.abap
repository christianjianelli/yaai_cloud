INTERFACE yif_aaic_diagram_google
  PUBLIC.
  ...
  METHODS:
    ...
    get_chat_messages
      ...
      RETURNING VALUE(r_t_messages) TYPE yif_aaic_google=>ty_contents_t,
    ...
    add_message
      IMPORTING
        i_s_msg TYPE yif_aaic_google=>ty_contents_s,

    parse_json
      IMPORTING
        i_json  TYPE /ui2/cl_json=>json
      EXPORTING
        e_s_msg TYPE yif_aaic_google=>ty_contents_s,
